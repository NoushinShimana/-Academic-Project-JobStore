...
if(isset($_POST)) {
	...
	$optn = mysqli_real_escape_string($conn, $_POST['optn']);
	...
	if($result->num_rows == 0) {
		...
		$sql = "INSERT INTO company(name, companyname, category, optn,  contactno, website, email, password, aboutme, logo) VALUES ('$name', '$companyname', '$category', '$optn','$contactno', '$website', '$email', '$password', '$aboutme', '$file')";
