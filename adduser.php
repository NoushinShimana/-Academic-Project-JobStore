...
if(isset($_POST)) {
	...
	if($uploadOk == false) {
		...
		$sql = "INSERT INTO users(firstname, lastname, email, password, address, contactno, qualification, passingyear, dob, age, designation, logo, aboutme, skills) VALUES ('$firstname', '$lastname', '$email', '$password', '$address', '$contactno', '$qualification', '$passingyear', '$dob', '$age', '$designation', '$file', '$aboutme', '$skills')";
