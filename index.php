  ...
  <div class="content-wrapper" style="margin-left: 0px;">
    ...
    <section class="content-header bg-main" >
      <div class="container" style="margin-left: 0px; ">
        <div class="row">
          <div class="col-md-12 text-left index-head margin-top-10"   >
            
          
            <p><a class="btn btn-success btn-lg" href="jobs.php" role="button"  >Search Jobs</a></p>
            <p style="font-size: 25px">A platform for CSE jobs!</p>
<h1>All <b><i>CSE</i> </b>JOBS In One Place</h1>  
    ...
    <section class="content-header">
      <div class="container">
        <div class="row">
          <div class="col-md-12 latest-job margin-bottom-20" style="margin-top:20px; ">
          ...
          if($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) 
            {
              ...
              if($result1->num_rows > 0) {
                ...
                {
             ?>
            <div class="attachment-block clearfix" style="background-color: white ;  ">
             
              <div class="attachment-pushed">
                <h4 class="attachment-heading"><a a href="view-job-post.php?id=<?php  echo $row['id_jobpost']; ?>"><?php echo $row['jobtitle']; ?></a> <span class="attachment-heading pull-right">$<?php echo $row['maximumsalary']; ?>/Month</span></h4>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center latest-job margin-bottom-20">
            <h1>Candidates</h1>
            <p>Finding a job just got easier.</p>            
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/interviewed.jpeg" alt="Find Your desirable job & Get Interviewed">
              <div class="caption">
                <h3 class="text-center">Find Your desirable job & get Interviewed</h3>
              </div>
            </div>
          </div>
          <div class="col-sm-4 col-md-4">
    ...
    <section id="company" class="content-header">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center latest-job margin-bottom-20">
            <h1>Companies</h1>
            <p>Want to hire? Register your company for free, , post jobs and browse our talented employees</p>            
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4 col-md-4">
